export default function Footer() {
  return (
    <footer className='items-center bg-neutral-100 px-5 py-16'>
      <div className='container'>
        <div className='grid grid-cols-1 gap-4 lg:grid-cols-3'>
          <div className='lg:col-span-1'>
            <div>© 2023 SHOP. Tất cả các quyền được bảo lưu.</div>
          </div>
        ...
        <div className='mt-10 text-center text-sm'>
          ...
          <div className='mt-2'>© 2023 - Bản quyền thuộc về Công ty TNHH SHOP</div>
        </div>
      </div>
    </footer>
  )
